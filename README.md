...
In FileLoader.php line 173:
  ...
  The file "\reproduce\5.2.0\src\../config/services.yaml" does not contain valid YAML: Malformed inline YAML string at line 37 in \reproduce\5.2.0\src\../config/services.yaml (which is being imported from "\reproduce\5.2.0\src\Kernel.php").                                                                                                                                                                                                                                                               
